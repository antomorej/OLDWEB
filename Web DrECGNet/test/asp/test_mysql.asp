...
Sub TestDB()
	...
	if len(Err.Description)<>0 then 
		mes = " " & Err.Description & " MySQL connection cannot be established."
	else
		...
		if len(Err.Description)<>0 then 
			...
			mes = " MySQL connection was successfully established."
			IsSuccess = true
		end if
	end if
	Set objConn = Nothing
        ...
        <div class="contentLayout">
            <div class="contentContainer">
                <div class="pageContent">
                    <div class="pathBar">
                        <a href="/index.html.old">Site Home Page</a> &gt;</div>
                    ...
                    <div class="tabContent">
                        ...
                        <p>        
                        This page allows you to check connectivity between the SQL client on your
						host and one of remote database servers. You should have working accounts on the
						database servers you want to test. Here you can test the ability to connect to the MySQL server.</p>
